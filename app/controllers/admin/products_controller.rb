# thay appliciantionController thanhf Admincontroller, neu doi nhu v thi product se vao trong layout admin . xoas heets admin:: 
class Admin::ProductsController < AdminController
  ...
  private
    ...
    def admin_product_params
      # doi admin_product thanh product
